...
const TextAndButtonPart = () => {
  return (
    <div className="space-y-3 max-w-md ">
      ...
      >
        {
          "Introducing My Bank, India's pioneer in digital banking innovation. As the country's first digital bank, we are dedicated to transforming your banking experience into a seamless and efficient journey."
        }
      </p>
