  ...
  return (
    <div>
      <h1 className="text-3xl md:text-4xl  font-black mb-5 uppercase ">
        ...
        <span className="text-primary"> My Bank </span>
        Cards
      </h1>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-x-5 my-3">
        <div className="flex items-center gap-x-2 mb-2">
          ...
          <p className="font-semibold text-sm md:text-base">My Bank Regular</p>
        </div>
        <div className="flex items-center gap-x-2 mb-2">
          <CiCreditCard2 className="text-xl md:text-2xl  text-green-500" />
          <p className="font-semibold text-sm md:text-base">My Bank Plus</p>
        </div>
        <div className="flex items-center gap-x-2 mb-2">
          <FaRegCreditCard className="text-xl md:text-2xl  text-yellow-500" />
          <p className="font-semibold text-sm md:text-base">My Bank Gold</p>
        </div>
        <div className="flex items-center gap-x-2 mb-2">
          <FaCreditCard className="text-xl md:text-2xl  text-green-600" />
          <p className="font-semibold text-sm md:text-base">My Bank Premium</p>
        </div>
        <div className="flex items-center gap-x-2 mb-2">
