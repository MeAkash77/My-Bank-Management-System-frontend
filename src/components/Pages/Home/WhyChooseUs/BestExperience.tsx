  ...
  return (
    <div className="space-y-5 ">
      ...
      <p className="leading-relaxed  text-slate-900 text-justify dark:text-slate-50">
        {
          "At My Bank, we are committed to delivering an unparalleled experience. Our choice to prioritize excellence reflects in our innovative solutions, reliability, and customer-centric approach."
        }
      </p>
